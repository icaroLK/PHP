CREATE DATABASE bd_game DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE bd_game;
...
senha varchar(60) not null,  /* esse 60 é pra criptografia que vai ser aplicada depois */
tipo VARCHAR(10) NOT NULL default 'editor' /*  esse aqui é que quando for criado um usuário, o padrão sera editor  */
...
pais VARCHAR(50) NOT NULL DEFAULT 'Desconhecido'
)engine=InnoDB default charset=utf8;
...
FOREIGN KEY (id_prod) REFERENCES produtoras(id_prod)
)engine=InnoDB default charset=utf8;
